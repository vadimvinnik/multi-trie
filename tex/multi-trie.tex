...
Sections above describe operations on MVCNsets and multi-tries containing some
`ordinary' values. Now let us consider how do these objects interact with
functions, including how can a container populated with functions act as a
function.
...
and an MVCNset of functions to a single value, let us finally define an
operation that applies an MVCNset of functions to an MVCNset of values. 
