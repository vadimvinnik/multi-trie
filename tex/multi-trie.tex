...
\emph{addresses} of some values in memory are obviously a special case of their
...
more complicated than in logical semantics.
...
\emph{Maps}, \emph{dictionaries}~\cite{bib:dictionary} and associativer
...
(def.~\ref{df:mvcn-map}, \ref{df:mt-map} and st.~\ref{st:map-properties})
