...
dereferencing.  It replaces all values associated with some name with a new
set. Thus, it is similar to assignment in the sense of imperative programming.
...
\[
  \putval(p, u, s) = \{ (v, x) \mid (v, x) \in p, v \neq u \}
      \cup \{ (u, y) \mid y \in s \} .
\]
...
%TODO: define Put for sets and mts
