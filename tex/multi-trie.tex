...
Let us take a closer look at the uniting application. Take some compound
name~$w$ that could be represented as a concatenation, i.e. split into two
parts, in multiple ways.
